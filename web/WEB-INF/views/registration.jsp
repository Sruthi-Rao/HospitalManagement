...
<%--<form:form class="form-horizontal" action="/register" method="post" modelattribute =" registration">--%>
    ...
    <%--<div class="form-group">--%>
        ...
        <%--<div class="col-sm-10">--%>
            ...
            <%--<form:input type="text" path="firstName" class="form-control" id="firstName" name="firstName" placeholder="Enter first name">--%>
    ...
    <%--<div class="form-group">--%>
        ...
        <%--<div class="col-sm-10">--%>
            <%--<form:input type="text" path="lastName" class="form-control" id="lastName" name="lastName" placeholder="Enter last name">--%>
        <%--</div>--%>
    <%--</div>--%>
    ...
    <%--<div class="form-group">--%>
        ...
        <%--<div class="col-sm-10">--%>
            <%--<form:input type="radio" path="gender" class="form-check-input" name="gender" id="male" value="Male">Male--%>
        <%--</div>--%>
        <%--<div class="col-sm-10">--%>
    ...
    <%--<div class="form-group">--%>
        ...
        <%--<div class="col-sm-10">--%>
            <%--<form: input type="password"path="password" class="form-control" id="password" name="password" placeholder="Choose a password">--%>
        <%--</div>--%>
    <%--</div>--%>
...
<form:form class="form-horizontal" action="/register" method="post" modelAttribute="registration">
    <div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <form:errors path = "firstName" cssClass="f1"/>
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-2" for="lastName">Last Name:</label>
        <div class="col-sm-10">
            ...
            <form:errors path = "lastName" cssClass="f1"/>
        </div>
    </div>
